...
\begin{figure}[H]
  ...
  \includegraphics[keepaspectratio=true,scale=0.5]{figuras/graficoProdutividade.eps}
...
\begin{figure}[H]
  ...
  \includegraphics[keepaspectratio=true,scale=0.5]{figuras/graficoSatisfacao.eps}
...
\begin{figure}[H]
  ...
  \includegraphics[keepaspectratio=true,scale=0.5]{figuras/indicadorDificuldadeUso.eps}
...
\begin{figure}[H]
  ...
  \includegraphics[keepaspectratio=true,scale=0.5]{figuras/graficoDificuldade.eps}
...
\begin{figure}[H]
  ...
  \includegraphics[keepaspectratio=true,scale=0.5]{figuras/graficoNumeroErros.eps}
